...
def _parse_agents_md(content: str) -> dict:
    ...
    # Parse $CMEM line for project and last_updated
    for line in lines:
    ...
    # Extract observation titles (lines containing 🔵 🟣 🔴 🔄 ✅ ⚖️)
    # Skip header lines like "Legend:", "Format:", "Stats:"
