...
- [写入设计](03-write-path.md) — 创建流程（与本篇对称）
- [数据模型](01-data-model.md) — Entity 模型、versions 字段
- [搜索设计](04-search.md) — 去重时的搜索策略
- [Agent 接入](06-agent-integration.md) — 触发时机规则
- [初始化与并发](08-init-and-concurrency.md) — 并发写入协调
