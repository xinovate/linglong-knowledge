...
- [目录结构](02-directory-structure.md) — 索引文件布局
- [写入设计](03-write-path.md) — 写入时的一致性检查
- [Agent 接入](06-agent-integration.md) — CLI 命令设计
- [初始化与并发](08-init-and-concurrency.md) — 写入-索引一致性保证
