...
**后端**：自建 SearXNG 实例 `http://localhost:8088`
...
| 文件 | 说明 |
|------|------|
| `src/linglong/ingest/agent.py` | `_search_all_keywords()` / `_github_trending()` / `_fetch_rss_feeds()` |
| `.linglong.yaml` | RSS 源列表、搜索关键词、SearXNG/RSSHub 配置 |
